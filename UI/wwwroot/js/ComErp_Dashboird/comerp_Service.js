...
const InitializegetServicevalidation = $(formName).validate({
...
export const CreateServiceBtn = async (CreateBtnId) => {
    // Show Create Model
...
window.updateService = async (id) => {
    ...
    try {
        ...
        if (result.success) {
            ...
            resetValidation(InitializegetServicevalidation, formName);
