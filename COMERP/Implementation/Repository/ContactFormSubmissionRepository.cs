...
namespace COMERP.Implementation.Repository
{
    public class ContactFormSubmissionRepository : Repository<ContactFormSubmission>, IContactFormSubmissionRepository
    {
        ...
        public Task<(bool Success, string id, string Message)> AddContactFormSubmissionSqlAsync(ContactFormSubmissionDto model)
        {
            throw new NotImplementedException();
        }

        public Task<(bool Success, string id, string Message)> UpdateContactFormSubmissionSqlAsync(ContactFormSubmissionDto model)
        {
            throw new NotImplementedException();
        }
    }
