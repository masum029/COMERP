...
namespace COMERP.Implementation.Repository
{
    public class SiteSettingsRepository : Repository<SiteSettings>, ISiteSettingsRepository
    {
        ...
        public Task<(bool Success, string id, string Message)> AddSiteSettingsSqlAsync(SiteSettingsDto model)
        {
            throw new NotImplementedException();
        }

        public Task<(bool Success, string id, string Message)> UpdateSiteSettingsSqlAsync(SiteSettingsDto model)
        {
            throw new NotImplementedException();
        }
    }
