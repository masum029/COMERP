...
namespace COMERP.Implementation.Repository
{
    public class PageContentRepository : Repository<PageContent>, IPageContentRepository
    {
        ...
        public Task<(bool Success, string id, string Message)> AddPageContentSqlAsync(PageContentDto model)
        {
            throw new NotImplementedException();
        }

        public Task<(bool Success, string id, string Message)> UpdatePageContentSqlAsync(PageContentDto model)
        {
            throw new NotImplementedException();
        }
    }
